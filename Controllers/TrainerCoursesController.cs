...
namespace SpartaWebApp.Controllers
{
    ...
    public class TrainerCoursesController : ControllerBase
    {
        ...
        public async Task<ActionResult<TrainerCourses>> PostTrainerCourses(TrainerCourses trainerCourses)
        {
            ...
            return CreatedAtAction("GetTrainerCourses", new { id = trainerCourses.Tcid }, trainerCourses);
        }
        ...
        {
            return _context.TrainerCourses.Any(e => e.Tcid == id);
        }
    }
}
